    ...
    <section className="relative min-h-screen flex items-center justify-center pt-20">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center px-4 animate-fade-in max-w-2xl mx-auto">
            <a
              href="https://wa.me/5519982482393"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-primary text-primary-foreground px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 rounded-lg hover:bg-primary/90 transition-all duration-300 font-semibold text-sm sm:text-base md:text-lg shadow-lg hover:shadow-xl inline-flex items-center justify-center gap-2"
            >
            ...
            <a
              href="#produtos"
              className="bg-white/10 text-secondary-foreground border-2 border-white/60 px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 rounded-lg hover:bg-white hover:text-secondary transition-all duration-300 font-semibold text-sm sm:text-base md:text-lg inline-flex items-center justify-center"
            >
              Nossos produtos
            </a>
          </div>
