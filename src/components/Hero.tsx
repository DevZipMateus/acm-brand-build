      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8 items-start mb-6 md:mb-8 animate-fade-in">
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center px-4">
                <a
                  ...
                  className="bg-primary text-primary-foreground px-5 sm:px-6 py-2.5 sm:py-3 rounded-lg hover:bg-primary/90 transition-all duration-300 font-semibold text-sm sm:text-base shadow-lg hover:shadow-xl inline-flex items-center justify-center gap-2"
                >
                ...
                <a
                  href="#produtos"
                  className="bg-white/10 text-secondary-foreground border-2 border-white/60 px-5 sm:px-6 py-2.5 sm:py-3 rounded-lg hover:bg-white hover:text-secondary transition-all duration-300 font-semibold text-sm sm:text-base inline-flex items-center justify-center"
                >
                  Nossos produtos
                </a>
              </div>
            ...
            {/* Right Column - Parking Banner Image */}
