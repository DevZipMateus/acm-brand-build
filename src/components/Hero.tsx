        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in">
            <a
              ...
              className="bg-primary text-primary-foreground px-8 py-4 rounded-lg hover:bg-primary/90 transition-all duration-300 font-semibold text-lg shadow-lg hover:shadow-xl inline-flex items-center justify-center gap-2"
            >
            ...
            <a
              href="#produtos"
              className="bg-white/10 text-secondary-foreground border-2 border-white/60 px-8 py-4 rounded-lg hover:bg-white hover:text-secondary transition-all duration-300 font-semibold text-lg inline-flex items-center justify-center"
            >
              Nossos produtos
            </a>
          </div>
