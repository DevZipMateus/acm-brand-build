    ...
    <section id="contato" className="py-12 sm:py-16 lg:py-20 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-3 sm:mb-4">Entre em contato</h2>
          <div className="w-16 sm:w-20 h-1 bg-primary mx-auto mb-8 sm:mb-12"></div>

          <div className="max-w-2xl mx-auto">
            <div className="bg-card rounded-xl sm:rounded-2xl shadow-xl p-6 sm:p-8 md:p-10">
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                >
                  ...
                  <div>
                    <p className="font-semibold mb-0.5 sm:mb-1 text-sm sm:text-base">Telefone / WhatsApp</p>
                    <p className="text-sm sm:text-base text-muted-foreground">(19) 98248-2393</p>
                  </div>
                </a>
                ...
                <div className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 rounded-lg">
                  ...
                  <div>
                    <p className="font-semibold mb-0.5 sm:mb-1 text-sm sm:text-base">Endereço</p>
                ...
                <div className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 rounded-lg">
                  ...
                  <div>
                    <p className="font-semibold mb-0.5 sm:mb-1 text-sm sm:text-base">Horário de atendimento</p>
                    <p className="text-sm sm:text-base text-muted-foreground">Segunda a sexta-feira</p>
                    <p className="text-sm sm:text-base text-muted-foreground">9h às 17h30</p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div>
                    <p className="font-semibold mb-0.5 sm:mb-1 text-sm sm:text-base">Instagram</p>
                    <p className="text-sm sm:text-base text-muted-foreground">@acmcarimbos</p>
                  </div>
                </a>
              </div>
            </div>
          ...
          <div className="mt-8 sm:mt-12 text-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-primary text-primary-foreground px-6 sm:px-10 py-3 sm:py-4 rounded-lg hover:bg-primary/90 transition-all duration-300 font-semibold text-base sm:text-lg inline-flex items-center gap-2 sm:gap-3 shadow-lg hover:shadow-xl"
            >
